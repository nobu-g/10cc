...
assert 1 "int main() {char a; char b; char c; char d; a = 1; b = 2; c = 3; d = 4; char *p; p = &b; char *q; q = p + 2; return *q;}"
assert 2 "int main() {char a; char b; char c; char d; a = 1; b = 2; c = 3; d = 4; char *p; p = &c; char *q; q = p + 2; return *q;}"
assert 1 "int main() {char a; char b; char c; char d; a = 1; b = 2; c = 3; d = 4; char *p; p = &b + 2; return *p;}"
assert 2 "int main() {char a; char b; char c; char d; a = 1; b = 2; c = 3; d = 4; char *p; p = &c + 2; return *p;}"
assert 2 "int main() {char a; char b; char c; a = 1; b = 2; c = 3; char *p; p = &c + 1; return *p;}"
